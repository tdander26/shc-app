...
export default function HomePage() {
  return (
    <div className="slide-up">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-shc-text text-center mb-2">SHC App</h1>
        <p className="text-center text-shc-muted text-sm">Symptom-Based Health Coaching</p>
      </div>
